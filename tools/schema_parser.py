# ==============================================================================
# tools/schema_parser.py — Barreira de Segurança + Extração de Metadados
# ==============================================================================
#
...
def extract_safe_schema(df: pd.DataFrame, table_name: str = "tabela") -> str:
    ...
    Exemplo de saída:
        ══════════════════════════════════════════
        🔒 ESQUEMA SEGURO — fVendas
        ══════════════════════════════════════════
        📋 Tabela: fVendas
        Linhas: 15.420 | Colunas: 7

        Colunas:
          • ID_Venda          → Número Inteiro
          • Data_Venda        → Data/Hora
          • Valor_Unitario    → Número Decimal
          • Nome_Cliente      → Texto
    """
